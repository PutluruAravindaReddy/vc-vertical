...
<>
  ...
  <div className="max-w-[85rem] px-4 py-6 sm:px-6 lg:px-8 lg:py-10 mx-auto">
    {/* Title */}
    <div className="max-w-[79rem] mx-auto text-start mb-6 lg:mb-6">
    ...
    <div className="max-w-[85rem] mx-auto">
      ...
      <div className="hs-accordion-group">
        ...
        >
          ...
          >
            Optical biosensor based cancer cell detection using optimized machine learning model with quantum computing
            <svg
