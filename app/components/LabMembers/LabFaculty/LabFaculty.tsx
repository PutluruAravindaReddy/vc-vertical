      ...
      <div className="max-w-[85rem] px-4 pb-10 pt-5 sm:px-6 lg:px-8 lg:pb-14 lg:pt-5 mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 ">
          ...
          >
            <div className="relative pt-[50%] sm:pt-[70%] rounded-xl overflow-hidden">
              <img
                className="size-full w-[90%] pl-[5%] absolute top-0 start-0 object-cover group-hover:scale-105 transition-transform duration-500 ease-in-out rounded-2xl"
                src="/img/faculty/arthi_mam.jpeg"
                alt="Image Description"
              />
            </div>
            <div className="mt-7 p-4">
