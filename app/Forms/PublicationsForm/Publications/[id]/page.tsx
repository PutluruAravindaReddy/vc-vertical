    ...
    const fetchPublication = async () => {
      try {
        const response = await fetch(
          `/api/PublicationsRoute/Publications/${publicationId}`,
          {
            method: "GET",
            headers: {
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-4">
          ...
          <input
            ...
            onChange={(e) =>
              setPublication({ ...publication, year: Number(e.target.value) })
            }
            className="border border-gray-300 px-4 py-2 w-full rounded-md mb-4"
          />
          <input
          ...
          <input
            ...
            onChange={(e) =>
              setPublication({ ...publication, SNIP: Number(e.target.value) })
            }
            className="border border-gray-300 px-4 py-2 w-full rounded-md mb-4"
          />
          <input
          ...
          <input
            ...
            onChange={(e) =>
              setPublication({ ...publication, link: e.target.value })
            }
            className="border border-gray-300 px-4 py-2 w-full rounded-md mb-4"
          />
          <input
