    ...
    const fetchPatent = async () => {
      try {
        const response = await fetch(
          `/api/PublicationsRoute/Patents/${patentId}`,
          {
            method: "GET",
            headers: {
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-4">
          ...
          <input
            ...
            onChange={(e) =>
              setPatent({ ...patent, applicationNumber: e.target.value })
            }
            className="border border-gray-300 px-4 py-2 w-full rounded-md mb-4"
          />
          <input
          ...
          <input
            ...
            onChange={(e) =>
              setPatent({ ...patent, dateOfFiling: e.target.value })
            }
            className="border border-gray-300 px-4 py-2 w-full rounded-md mb-4"
          />
          <input
            ...
            onChange={(e) =>
              setPatent({ ...patent, publicationDate: e.target.value })
            }
            className="border border-gray-300 px-4 py-2 w-full rounded-md mb-4"
          />
          <input
            ...
            onChange={(e) =>
              setPatent({ ...patent, dateOfGrant: e.target.value })
            }
            className="border border-gray-300 px-4 py-2 w-full rounded-md mb-4"
          />
          <input
            ...
            onChange={(e) =>
              setPatent({ ...patent, designNumber: e.target.value })
            }
            className="border border-gray-300 px-4 py-2 w-full rounded-md mb-4"
          />
          <input
            ...
            onChange={(e) =>
              setPatent({ ...patent, patentOffice: e.target.value })
            }
            className="border border-gray-300 px-4 py-2 w-full rounded-md mb-4"
          />
          <input
