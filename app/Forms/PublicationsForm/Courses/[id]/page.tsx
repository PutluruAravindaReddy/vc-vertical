    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-4">
        ...
        <input
          ...
          onChange={(e) => setCourse({ ...course, faculty: e.target.value.split(',').map(fac => fac.trim()) })}
          className="border border-gray-300 px-4 py-2 w-full rounded-md mb-4"
        />
        <input
          type="text"
        ...
        <input
          ...
          onChange={(e) => setCourse({ ...course, badgeEarned: e.target.value })}
          className="border border-gray-300 px-4 py-2 w-full rounded-md mb-4"
        />
      </div>
      <Link href="/publications" onClick={handleEditCourse} className="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-md cursor-pointer">
        Save Changes
      </Link>
    </div>
  );
