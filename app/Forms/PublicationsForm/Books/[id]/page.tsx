    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-4">
        ...
        <input
          ...
          onChange={(e) => setBook({ ...book, authors: e.target.value.split(',').map(author => author.trim()) })}
          className="border border-gray-300 px-4 py-2 w-full rounded-md mb-4"
        />
        <input
          type="text"
        ...
        <input
          ...
          onChange={(e) => setBook({ ...book, editors: e.target.value.split(',').map(editor => editor.trim()) })}
          className="border border-gray-300 px-4 py-2 w-full rounded-md mb-4"
        />
        <input
          type="text"
      ...
      <Link href="/publications" onClick={handleEditBook} className="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-md cursor-pointer">
        Save Changes
      </Link>
    </div>
  );
