...
export const metadata:Metadata = {
  ...
  twitter: {
    ...
    description: 'Discover the Visual Computing Lab and the Computer Vision vertical at SRM Institute of Science and Technology, dedicated to cutting-edge research and student collaboration.',
  ...
  themeColor: '#000000',
  keywords: ['Computer Vision','srmist','vclab srmist','srm','vertical srm', 'Visual Computing Lab', 'SRM University', 'SRM Institute of Science and Technology', 'CV projects', 'research', 'technology', 'education'],
  robots: 'index,follow',
